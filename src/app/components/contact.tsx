        ...
        <section className=" body-font relative -mt-[50px]">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-12">
              <h1 className="sm:text-3xl text-3xl font-bold title-font mb-4 text-yellow-600 " data-aos="zoom-in-up">
                Contact Us
              </h1>
            ...
            <div className="lg:w-1/2 md:w-2/3 mx-auto">
              <div className="flex flex-wrap -m-2">
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="name"
                      name="name"
                      className="w-full bg-gray-100 bg-opacity-50 rounded focus:ring-2 focus:ring-yellow-200  border-2 border-black focus:border-red-800  focus:bg-white  text-base outline-none  py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" data-aos="zoom-in-up"
                      required />
                  </div>
                </div>
                <div className="p-2 w-1/2">
                ...
                <div className="p-2 w-full" data-aos="zoom-in-up">
                  <button className="flex mx-auto text-white bg-yellow-600 font-bold border-0 py-2 px-8 focus:outline-none hover:bg-yellow-700 rounded text-lg">
                    Submit
                  </button>
                </div>
              </div>
